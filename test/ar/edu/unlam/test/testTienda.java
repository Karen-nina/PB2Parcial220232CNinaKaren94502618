...
import ar.edu.unlam.dominio.ClienteInexistenteException;
import ar.edu.unlam.dominio.Producto;
import ar.edu.unlam.dominio.Servicio;
import ar.edu.unlam.dominio.StockInsuficienteException;
import ar.edu.unlam.dominio.Tienda;
import ar.edu.unlam.dominio.Vendedor;
import ar.edu.unlam.dominio.VendedorInexistenteException;
import ar.edu.unlam.dominio.Vendible;
import ar.edu.unlam.dominio.VendibleInexistenteException;
import ar.edu.unlam.dominio.Venta;
import ar.edu.unlam.dominio.VentaInexistenteException;
...
public class testTienda {
	...
	@Test
	public void queSePuedaHacerUnaVentaDeUnServicio() throws VentaInexistenteException, VendibleInexistenteException, StockInsuficienteException {
		Tienda tienda = new Tienda("30123456780", "Tienda de ejemplo");
		String cuitCliente = "30123456780";
		Cliente cliente = new Cliente(cuitCliente, "Cliente de ejemplo");
		tienda.agregarCliente(cliente);
